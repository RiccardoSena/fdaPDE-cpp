...
TEST(inferencetime_test, spacetime25D) {
    ...
    DVector<double> waldpvalf = inferenceW.f_p_value();

    EXPECT_TRUE(almost_equal(waldpval(0), 0.7660934 , 1e-7));
    EXPECT_TRUE(almost_equal(waldpval(1), 0.715712 , 1e-7));
    EXPECT_TRUE(almost_equal(speckpval(0), 0.7660934 , 1e-7));
    EXPECT_TRUE(almost_equal(speckpval(1), 0.715712 , 1e-7));
    EXPECT_TRUE(almost_equal(esfpval(0), 0.7660934 , 1e-3));
    EXPECT_TRUE(almost_equal(esfpval(1), 0.715712 , 1e-3));
    //EXPECT_TRUE(almost_equal(waldpvalf, 0.715712 , 1e-7));
